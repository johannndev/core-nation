<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Stat Item Group</p>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <form action="{{route('item.statFilterGroup',$tid)}}" method="get">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr  class="border-b dark:border-gray-700 hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-3"><x:partial.stat-sum  :bulan='$bulan'  :tahun='$tahun' :type='$sellCode' :tid='$tid' :group='$typeStat' /></td>
                                    <td class="px-4 py-3"><x:partial.stat-sum :bulan='$bulan'  :tahun='$tahun' :type='$returnCode' :tid='$tid' :group='$typeStat' /></td>
                                    <td class="px-4 py-3"><x:partial.stat-sum :bulan='$bulan'  :tahun='$tahun' :type='$moveCode' :tid='$tid' :group='$typeStat'/></td>
                                    <td class="px-4 py-3"><x:partial.stat-sum :bulan='$bulan'  :tahun='$tahun' :type='$prodCode' :tid='$tid' :group='$typeStat'/></td>
                                </tr>
                                @endforeach
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-3 font-bold"><x:partial.stat-total :type='$sellCode' :tid='$tid' :group='$typeStat'/></td>
                                    <td class="px-4 py-3 font-bold"><x:partial.stat-total :type='$returnCode' :tid='$tid' :group='$typeStat'/></td>
                                    <td class="px-4 py-3 font-bold"><x:partial.stat-total :type='$moveCode' :tid='$tid' :group='$typeStat'/></td>
                                    <td class="px-4 py-3 font-bold"><x:partial.stat-total :type='$prodCode' :tid='$tid' :group='$typeStat'/></td>
