<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Detail Item #{{$data->invoice}}</p>
    ...
    <div class="mb-8">
        ...
        <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px">
                ...
                <li class="me-2">
                    <a href="{{route('item.detail',$tid)}}" class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">Detail</a>
                </li>
                <li class="me-2">
                    ...
                    <div class="grid grid-cols-1 divide-y">
                        ...
                        <div>
                            <div class="grid grid-cols-5 p-4">
                                ...
                                <div class="col-span-3">
                                    <a href="{{route('item.edit',$data->id)}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</a>
                                </div>
                            </div>
                        </div>
