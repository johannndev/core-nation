        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <form action="{{route('item.filterGroup')}}" method="get">
                        <div class="flex flex-col md:flex-row items-end justify-between p-4">
                            ...
                            <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                ...
                                <a href="{{route('item.group')}}" class="flex items-center justify-center py-2 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                    ...
                                    <th scope="row" class="px-4 py-3  whitespace-nowrap ">
                                        ...
                                        <a href="{{route('item.detailGroup',$item->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{$item->name}}</a>

                                    </th>
                           
                                    <td class="px-4 py-3">{{$item->master}}</td>
                                    <td class="px-4 py-3">{{$item->alias}}</td>
                                   
                                    <td class="px-4 py-3">{{$item->variant}}</td>
                                    <td class="px-4 py-3">{{$item->description}}</td>
                                
                                    <td class="px-4 py-3">{{\App\Helpers\ItemsManagerHelper::findGroupInWarehouse($item->id)}}</td>
