<x-layouts.layout>
    ...
    <form class="myForm" id="myForm" action="{{route('transaction.cashOutPost')}}" method="post" >
                            ...
                            <div id="dynamicAddRemove">
                                ...
                                <div class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-5 items-end addField0 "id="gridItem0">
                                    ...
                                    <div>
                                        ...
                                        <input onkeyup="return handleInvoice(event,0)" type="search" name="addMoreInputFields[0][invoice]"  id="invoice0" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" inputmode="search"/>
                                    </div>  
