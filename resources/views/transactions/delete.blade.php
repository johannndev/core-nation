<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Deleted Transactions List</p>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <form action="{{route('transaction.deletefilter')}}" method="get">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                    <th scope="row" class="px-4 py-3  whitespace-nowrap ">
                                        ...
                                        <a href="{{route('transaction.getDetailDelete',$item->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{\Carbon\Carbon::parse($item->date)->format('d/m/Y')}}</a>
