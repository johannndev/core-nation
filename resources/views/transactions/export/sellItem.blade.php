                        ...
                        <div class="flex flex-col md:flex-row items-end justify-between p-4">
                            ...
                            <div class="w-full md:w-4/6">
                                ...
                                <div class="grid gap-4 md:grid-cols-5">
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <label for="submit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Submit Type</label>
                                        <select id="submit" name="submit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option value="">Choose a Type</option>
                                            <option value="">All</option>
                                            <option {{Request('submit') == 'aria' ? 'selected' : 'null'}} value="aria">Aria</option>
                                            <option {{Request('submit') == 'desty' ? 'selected' : 'null'}} value="desty">Desty</option>
                            ...
                            <div class=" mt-4 md:mt-0 w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                ...
                                <div>
                                        ...
                                        <a href="{{ route('export.sellItemBuild',['from' => Request('from'), 'to' => Request('to'), 'whId' =>Request('whId'),'type' =>Request('type'),'invoice' =>Request('invoice')]) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Export</a>

                                        <a href="{{ route('export.desty',['from' => Request('from'), 'to' => Request('to'), 'whId' =>Request('whId'),'type' =>Request('type'),'invoice' =>Request('invoice'),'submit' =>Request('submit')]) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Desty</a>
