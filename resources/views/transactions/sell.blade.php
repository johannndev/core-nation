                        ...
                        <div class="mb-6">
                            ...
                            <div id="dynamicAddRemove">
                                ...
                                <div class="grid gap-6 mb-6 md:grid-cols-8 items-end addField0 "id="gridItem0">
                                    ...
                                    <div>
                                        <label for="discount" class="block mb-2 text-sm font-medium text-gray-900 ">Discount</label>
                                        <input oninput="return handleDisc(event,0)" type="text" name="addMoreInputFields[0][discount]"   id="discount0" class="register_form bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" />
                                    </div> 
