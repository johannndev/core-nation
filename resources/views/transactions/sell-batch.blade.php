                    ...
                    <div class="">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-8">
                            ...
                            <div class="col-span-2">
                                ...
                                <div id="errorWrap" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                    <span class="font-medium">Gagal upload!</span id="errorMessage"> Change a few things up and try submitting again.
                                </div>
