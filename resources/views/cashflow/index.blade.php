        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <form action="{{route('filter.get',['action' =>'customer.index'])}}" method="post">
                        @csrf
                        ...
                        <div class="flex flex-col md:flex-row items-end justify-between p-4">
                            ...
                            <div class="w-full md:w-4/6">
                                ...
                                <div class="grid gap-4 md:grid-cols-5 items-end">
                                    <div>
                                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bulan</label>
                ...
                <div class="mt-6 mb-4">
                    <p class="font-bold text-lg">By Sender</p>
                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Addr Book</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                        ...
                                        <th scope="row" class="px-4 py-3  whitespace-nowrap ">
                                            ...
                                            <a href="" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{$item->type_name}}</a>
                    
                                        </th>

                                        <td class="px-4 py-3">{{$item->type_sender_name}}</td>
                                       
                                        <td class="px-4 py-3">{{Number::format($item->total_sum,2)}}</td>
                ...
                <div class="mt-6 mb-4">
                    <p class="font-bold text-lg">By Recaiver</p>
                </div>
                    ...
                    <div>
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    @forelse ( $groupByReceiver as $item)
                                    ...
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                        ...
                                        <td class="px-4 py-3">{{$item->type_recaiver_name}}</td>
