<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Edit Role</p>
    ...
    <form action="{{route('role.roleUpdate',$data->id)}}" method="post" >
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
                    ...
                    <div class="">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-xl font-medium mt-6 mb-4">Access Control</p>

                            <div class="flex items-center">
                                <input id="checkbox-all" name="all" type="checkbox" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="checkbox-all" class="ms-2 font-medium text-sm text-gray-900 dark:text-gray-300">Semua</label>
                            </div>
                        </div>

                       
                        
                        <x-partial.permission :data="$data"/>
