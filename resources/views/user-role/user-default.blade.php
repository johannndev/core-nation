        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <a href="{{ route('user.userDefaultCreate') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create</a>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                        ...
                                        <td class="px-4 py-3 flex">
                                            <a href="{{route('user.userDefaultEdit',$item->id)}}" class=" items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-primary-800">
                                                Edit
                                            </a>

                                            <form action="{{ route('user.userDefaultDelete',$item->id) }}" method="post">
