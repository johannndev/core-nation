<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">{{$location->name}} detail</p>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <form action="{{route('filter.get',['id' => $location->id,'action' =>'location.detail'])}}" method="post">
                        @csrf
                        ...
                        <div class="flex flex-col md:flex-row items-end justify-between p-4">
                            ...
                            <div class="mt-4 w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                ...
                                <a href="{{route('location.detail',$location->id)}}" class="flex items-center justify-center py-2 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                        ...
                                        <td class="px-4 py-3 flex">
                                            ...
                                            <form method="post" action="{{ route('location.dismis',[$location->id,$item->id]) }}">

                                                @csrf

                                                <button type="submit" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 me-2  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Dismis</button>
