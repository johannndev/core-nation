<x-layouts.layout>
    ...
    <div class="mb-8">
      ...
      @endif
        ...
        <form action="{{route('produksi.postEdit',$data->id)}}" method="post">
    ...
    <div class="mb-8">
        ...
        <form action="{{route('produksi.postPisahJahit',$data->id)}}" method="post">
        ...
        <section class="bg-gray-50 dark:bg-gray-900 ">
            <div class="mx-auto  ">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden  p-4">
                    ...
                    <div class="">
                        <div class="px-4 sm:px-0">
                          <h3 class="text-base font-semibold leading-7 text-gray-900">Pisah Jahit
                        </h3>
                          {{-- <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Personal details and application.</p> --}}
                        </div>
                        <div class="mt-6 border-t border-gray-100">
                          <dl class="divide-y divide-gray-100">
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                <dt class="text-sm font-medium leading-6 text-gray-900">Pisah Jahit</dt>
                                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    <input type="text" id="split_q" name="split_q" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value=" " />
                                 </dd>
                            </div>
    ...
    <div class="mb-8">
        ...
        <form action="{{route('produksi.postGantiJahit',$data->id)}}" method="post">
       ...
       <div class="mb-8">
        ...
        <form action="{{route('produksi.postGantiQc',$data->id)}}" method="post">
