                                    ...
                                    <div>
                                        <div class="flex mt-2 md:mt-0">
                                            ...
                                            <div>
                                                ...
                                                <a href="{{route('jubelio.manual.create',$item->id)}}" type="button" class="capitalize text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-3 py-2 text-xs me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Manual Create</a>
