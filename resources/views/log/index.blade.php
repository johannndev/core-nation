                                ...
                                <div class="flex justify-start md:justify-between flex-col md:flex-row">
                                    ...
                                    <div>
                                        <div class="flex items-center mt-2 md:mt-0">
                                            ...
                                            <div>
                                                <a href="#" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg px-3 py-2 text-xs me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Solved</a>
