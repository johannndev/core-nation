<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Jubelio Update Solved</p>
    ...
    <form id="myForm" action="{{route('jubelio.solved.store',$sid)}}" method="post" >
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                        ...
                                        <td class="px-6 py-4 w-32">
                                            <img src="{{$item['thumbnail']}}" alt="" srcset="" class="">
                                        </td>

                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900  dark:text-white w-80">
                                           {{$item['item_name']}}
                                        </th>
                                        <td class="px-6 py-4">
                                            {{$item['item_code']}}
