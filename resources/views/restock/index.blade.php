                                    ...
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                        ...
                                        <td class="px-4 py-3 ">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if ($item->in_production_quantity > 0)
                                                    <a href="{{ route('restock.resetSingleQty', [$item->id, 'type' => 'production']) }}"
                                                        title="Reset In Production QTY"
                                        ...
                                        <td class="px-4 py-3 ">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if ($item->shipped_quantity > 0)
                                                    <a href="{{ route('restock.resetSingleQty', [$item->id, 'type' => 'shipped']) }}"
                                                        title="Reset Shipped QTY"
                                                        class="text-red-600 hover:text-red-800">
