<x-layouts.layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
        ...
        <p class="text-2xl font-bold">Desty Sync</p>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">ID Gudang</th>

                                        <th scope="col" class="px-4 py-3">ID Slot</th>
                                    ...
                                    @forelse ($dataList as $item)
                                        <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                            ...
                                            <td class="px-4 py-3 flex">
                                                ...
                                                <a href="{{ route('desty.sync.edit', $item->id) }}"
                                                    class=" items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-primary-800">
                                                    Edit
                                                </a>

                                                <form action="{{ route('desty.sync.delete', $item->id) }}"
                                                    method="post">
                                                    ...
                                                    <button type="submit"
                                                        class=" items-center justify-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
                                                        Delete
