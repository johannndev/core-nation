                                ...
                                <div class="grid gap-4 md:grid-cols-5 items-end">
                                    ...
                                    <div>
                                        ...
                                        <select id="status" name="status"
                                            ...
                                            <option {{ Request('status') == 'warning' ? 'selected' : '' }}
                                                value="warning">Warning</option>
                                            <option {{ Request('status') == 'error' ? 'selected' : '' }} value="error">
                                                Error</option>
                                            <option {{ Request('status') == 'success' ? 'selected' : '' }}
                                    ...
                                    @forelse ( $dataList as $item)
                                        ...
                                        <tr class="border-b dark:border-gray-700 hover:bg-gray-100">
                                            ...
                                            <th class="px-4 py-3">
                                                @if ($item->source == 1)
                                                    <span
                                                        class="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-sm me-2 dark:bg-blue-700 dark:text-blue-400 border border-blue-500 ">
                                                        Jubelio
                                                    </span>
                                                @else
                                                    <span
                                                        class="bg-yellow-100 text-yellow-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-sm me-2 dark:bg-yellow-700 dark:text-yellow-400 border border-yellow-500 ">
                                                        Aria
                                                    </span>
                                                @endif
                                            </th>
                                            ...
                                            <td class="px-4 py-3"><a target="_blank"
                                                    href={{ route('transaction.index', ['invoice' => $item->invoice, 'type' => 0]) }}
                                                ...
                                                <div>
                                                        ...
                                                        <span
                                                            ...
                                                            <div role="status">
                                                                <svg aria-hidden="true"
                                                                    class="w-2.5 h-2.5 me-1.5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                                                    ...
                                                    @elseif ($item->status == 1)
                                                        <div>
                                                            ...
                                                            <span
                                                                class="bg-red-100 text-red-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-sm me-2 dark:bg-red-700 dark:text-red-400 border border-red-500 ">

                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 24 24" fill="currentColor"
                                                                    class="w-2.5 h-2.5 me-1.5" stroke-width="2"
                                                                    stroke="currentColor">
                                                                    <path fill-rule="evenodd"
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <span
                                                                class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">{{ $dataApi['store_name'] }}</span>

                                                            <span
                                                                class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">{{ $dataApi['location_name'] }}</span>
                                                    ...
                                                    @elseif ($item->status == 2)
                                                        <div>
                                                            ...
                                                            <span
                                                                class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-sm me-2 dark:bg-green-700 dark:text-green-400 border border-green-500 ">
                                                                ...
                                                                Success submit by
                                                                {{ $item->execute_by == 0 ? 'Cron' : $item->user->name }}
                                                            </span>
