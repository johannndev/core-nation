        ...
        const newLine = `
            ...
            <div class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-5 items-end addField`+i+`" "id="gridItem`+i+`">
                ...
                <div>
                    ...
                    <input onkeyup="return handleTotal(event,`+i+`)" type="search" name="addMoreInputFields[`+i+`][total]"   id="total`+i+`" class="register_form bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" inputmode="search"/>
                </div> 
