    ...
    <ul class="space-y-2" style="overflow:scroll;padding-bottom:10px;">
        ...
        <li>
            ...
            <ul id="dropdown-user" class="hidden py-2 space-y-2">
                ...
                @endcan
                <li>
                    <a href="{{route('user.userDefault')}}" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User Setting</a>
                </li>
            </ul>
        </li>
