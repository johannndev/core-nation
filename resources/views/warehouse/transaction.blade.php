                    ...
                    <form action="{{route('filter.get',['id' => $cid, 'action' =>'warehouse.transaction'])}}" method="post">
                        <div class="flex flex-col md:flex-row items-end justify-between p-4">
                            ...
                            <div class="mt-4 w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                                ...
                                <a href="{{route('export.transaction',['cid'=>$cid, 'from'=>Request('from'), 'to'=>Request('to'), 'type'=>Request('type'),'page'=>Request('page'),'filename'=>'warehouse_transaction'])}}" class="flex items-center justify-center focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
