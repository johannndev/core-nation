<script>
    ...
    $(document).ready(function() {
        // Inisialisasi Select2 pada dropdown yang sudah ada
        $('.select2').select2();

        $('#addRow').click(function() {
            const newRow = `
                <div class="inputRow">
                    <select class="select2" name="input[]">
...
<script>
    ...
    function totalQty(){
        ...
        function initializeSelect2() {
            ...
            $('.select2-ajax-item').on('change', function() {
                var valCode = $(this).val();

                var dataId = $('.select2-ajax-item').attr('data-customId');
                ...
                document.getElementById("quantity"+dataId).focus();
            ...
            const newRow = `
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-8 items-end addField`+i+` "id="gridItem`+i+`">
                    ...
                    <div>
                        ...
                        <div class="flex items-end w-full ">
                            ...
                            <div class=" w-full">
                                ...
                                <div class="relative ">
                                    <select class="select2-ajax-item" name="addMoreInputFields[`+i+`][name]" data-customId="`+i+`">
                                        <option ></option>
                                    </select>
                    ...
                    <div>
                        ...
                        <div class="flex items-end w-full">
                            ...
                            <div class="w-full">
                                ...
                                <input data-name="quantity" data-id="0"  onkeyup="return handleQty(event,`+i+`)" type="search" name="addMoreInputFields[`+i+`][quantity]"  id="quantity`+i+`" class="qty register_form bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" inputmode="search"/>
                            </div>
                    ...
                    <div>
                        ...
                        <input  type="text" name="addMoreInputFields[`+i+`][wh]"   id="wh0"class=" bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" disabled/>
                    </div>  
                    ...
                    <div>
                        ...
                        <div class="flex items-end w-full">
                            ...
                            <div class="w-full">
                                <input data-name="price" data-id="0"  onkeyup="return handlePrice(event,`+i+`)" type="search" name="addMoreInputFields[`+i+`][price]"  id="price`+i+`" class="register_form bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" inputmode="search"/>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-end w-full">
                            ...
                            <div class="w-full">
                                <input data-name="discount" data-id="0" onkeyup="return handleDisc(event,`+i+`)" type="search"   name="addMoreInputFields[`+i+`][discount]"   id="discount`+i+`" class="register_form bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" inputmode="search" />
                            </div>
